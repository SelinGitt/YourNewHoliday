...
<p id="titrePage">
    <spring:message code="glb.titre.page.listerUtilisateur" />
</p>
...
<c:if test="${not empty error}">
    <div class="background-error-block block-message-commun">
        <span class="fa fa-exclamation"></span> <span class="user01-message"><spring:message code="${error}" /></span>
    </div>
</c:if>
                ...
                <c:forEach items="${listeUtilisateur}" var="utilisateurDto">
                    <tr>
                        ...
                        <td class="user01-body"><c:choose>
                                ...
                                checkboxVide"
                                        alt="" src="img/commun/checkboxVide.png">
                                </c:when>
                                <c:otherwise>
