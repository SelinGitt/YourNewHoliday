...
<div id="header">
		...
		<div class="headerSousCell">
			<c:choose>
				<c:when test="${sessionScope:utilisateur} != null">
					<a href="deconnecter.do"> <img
						src="img/template/header/deconnexion.png" class="logoHeader"
						alt="icône déconnexion">
					</a>
				</c:when>
				<c:otherwise>
					<a href=""> <img src="img/template/header/connexion.png"
						class="logoHeader" alt="icône connexion">
					</a>
				</c:otherwise>
			</c:choose>
		</div>
	...
	<div id="headerPanier" class="headerCell">
		<div class="headerSousCell">
			<a href=""> <img src="img/template/header/panierVide.png"
