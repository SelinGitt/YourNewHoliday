					...
					<div class="commandeLineCMD00">
						<div class="commandeReferenceCMD00">
							<a href="#"><spring:message
									code="listeCommande.reference.text" />${commande.reference}</a>
						</div>
						<div class="div.commandeQuantiteTotaleCMD00">
							<div class="div.commandeQuantiteTotaleTextCMD00">Quantité
								Totale :</div>
							<div class="div.commandeQuantiteTotaleValueCMD00">
